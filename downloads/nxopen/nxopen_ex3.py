...
def main():
    ...
    try:
        # 開啟零件檔案
        basePart1 = theSession.Parts.OpenBaseDisplay("Y:/mdecycu/cd2022_guide/downloads/nxopen/block.prt")
    except:
        # 檔案已經開啟
        pass
    ...
    sTLCreator1.OutputFile = "Y:/mdecycu/cd2022_guide/downloads/nxopen/block_ascii.stl"
    ...
    imageExportBuilder1.FileName = "Y:/mdecycu/cd2022_guide/downloads/nxopen/block.png"
