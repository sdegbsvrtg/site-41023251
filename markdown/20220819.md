...
只要在 [Github] 倉儲中放入 [HTML], [css] 與 [Javascript], 並且設定 [Github Pages] 對應的分支, [Github] 就會給定 Github_帳號.github.io/倉儲名稱 作為網址 (各學員課程網址將為: https://mdecp2022.github.io/site-學員_Github_帳號), 以 WWW 伺服器 server 使用者所提供的網頁內容.
